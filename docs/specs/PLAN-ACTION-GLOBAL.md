...
- [ ] Tous les tests de stockage et de proxies sont 100% verts. *(Proxies : oui, `cargo test -p atelier-controller -p atelier-net-proxy -p atelier-identity-proxy` 100% vert. Stockage S3 : hors scope de cette session, voir tâches 2.1.x.)*
- [x] Entrée documentée dans `docs/PROGRESS.md`.
