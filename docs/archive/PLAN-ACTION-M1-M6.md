# Archive du Plan d'Action — Jalons M1 à M6 (clos, septembre 2026)

> Détail tâche par tâche des jalons M1 à M6, sorti de
> [`../specs/PLAN-ACTION-GLOBAL.md`](../specs/PLAN-ACTION-GLOBAL.md) pour
> que celui-ci reste court et lisible — même raison que l'archivage de
> [`PROGRESS-2026-08.md`](PROGRESS-2026-08.md) : les 117 tâches de ce
> document sont toutes `[x]`, et le détail par tâche (fichiers touchés,
> preuves d'exécution) ne sert plus qu'à retrouver le contexte exact d'une
> décision passée — jamais à savoir quoi faire ensuite.
>
> **Ce document n'est plus mis à jour.** La Matrice Récapitulative (section
> 10, reproduite dans le document courant) reste la seule chose qu'il faut
> encore lire pour ces six jalons ; le reste ne sert qu'à l'archéologie.
>
> A consulter uniquement pour retrouver le detail d'une tâche M1-M6 déjà
> validée (fichiers exacts touchés, garde-fous appliqués, sous-tâches).
